      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-xl shadow-md border border-white/20 p-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
          <div>
            ...
            <p className="text-gray-600 text-xs">Real-time employee site visit tracking and location monitoring</p>
          </div>
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
            ...
            <button
              className="flex items-center justify-center space-x-1 px-3 py-2 text-xs bg-gradient-to-r from-blue-600 to-teal-600 text-white rounded-lg hover:from-teal-700 hover:to-teal-700 transition-all duration-300 shadow"
            >
